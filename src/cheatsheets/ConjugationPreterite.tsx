...
function ConjugationPreterite() {
  return (
    <CheatSheet title='Conjugation: Preterite'>
      <p>
        The preterite is used to describe what you previously did like, "I
        sang," or "I listened,"" and has different use cases than the imperfect
        tense."
      </p>
      ...
      <p>
        To conjugate a verb to the preterite, remove the -ar, -er, or -ir
        ending, and replace it with the appropriate ending above.
      </p>
      <p>
        Some verbs in the preterite are irregular and are conjugated
        differently.
      </p>
      ...
      <p>
        The only two stem changes in the preterite are <u>e -> i</u> and{' '}
        <u>o -> u</u>.
      </p>

      <h2 style={{ textAlign: 'center' }}>-car, -gar, -zar Verbs</h2>
      <p>
        Infinitives <u>ending in -car</u> will have their{' '}
        <u>"c" changed to "qu"</u> when conjugated{' '}
        <u>in the first person singular form</u>.
      </p>
      <p>
        Infinitives <u>ending in -gar</u> will have their{' '}
        <u>"g" changed to "gu"</u> when conjugated{' '}
        <u>in the first person singular form</u>.
      </p>
      <p>
        Infinitives <u>ending in -zar</u> will have their{' '}
        <u>"z" changed to "c"</u> when conjugated{' '}
        <u>in the first person singular form</u>.
      </p>
      <p>asd</p>
    </CheatSheet>
