...
function ConjugationImperfect() {
  return (
    <CheatSheet title='Conjugation: Imperfect'>
      <p>Similar to the preterite, the imperfect is used to describe things that had happened. More specifically, things that you were doing (progressive) or something you used to do.</p>
      ...
      <p>You must <u>include a clarifier for the first person singular and third person singular forms</u>, because they share the same ending.</p>
